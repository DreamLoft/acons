...
class PayeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payee" do
    assert_difference('Payee.count') do
      post payees_url, params: { payee: { payee_account: @payee.payee_account, payee_category_id: @payee.payee_category_id, payee_name: @payee.payee_name } }
    end
  ...
  test "should update payee" do
    patch payee_url(@payee), params: { payee: { payee_account: @payee.payee_account, payee_category_id: @payee.payee_category_id, payee_name: @payee.payee_name } }
