...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { apartment_name: @apartment.apartment_name, build_up: @apartment.build_up, carpet_area: @apartment.carpet_area, project_id: @apartment.project_id } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { apartment_name: @apartment.apartment_name, build_up: @apartment.build_up, carpet_area: @apartment.carpet_area, project_id: @apartment.project_id } }
