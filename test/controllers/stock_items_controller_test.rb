...
class StockItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stock_item" do
    assert_difference('StockItem.count') do
      post stock_items_url, params: { stock_item: { name: @stock_item.name, quantity: @stock_item.quantity } }
    end
  ...
  test "should update stock_item" do
    patch stock_item_url(@stock_item), params: { stock_item: { name: @stock_item.name, quantity: @stock_item.quantity } }
